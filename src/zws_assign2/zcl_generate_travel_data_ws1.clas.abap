CLASS zcl_generate_travel_data_ws1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_ws1 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_ws1.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_ws1.

*   insert the new table entries
    INSERT ztravel_ws1 FROM TABLE @itab.
